...
const BatchWiseConnect = () => {
  ...
  return (
    ...
    <div className="batch_card_container"> 
      ...
      <Card.Body>
        <Card.Text>
        Connect with {item} batch users.
        </Card.Text>
       {currentUser?( <Link className="event_card_link" to={`/connect/${item}`}><Button>View All</Button></Link>):(
            <Link className="event_card_link" to="/signup"><Button>View All</Button></Link>
       )}
      </Card.Body>
